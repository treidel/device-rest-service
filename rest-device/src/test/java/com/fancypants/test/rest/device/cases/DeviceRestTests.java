...
import com.fancypants.rest.device.config.RESTDeviceWebConfig;
...
@SpringApplicationConfiguration(classes = { RESTDeviceWebConfig.class,
...
public class DeviceRestTests {
	...
	private static final URI BASE_URL = URI
			.create("https://localhost:8001/device");
